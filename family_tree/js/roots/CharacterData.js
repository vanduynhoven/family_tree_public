...
export const CHARACTERS = [
  ...
  // ── Raven ─────────────────────────────────────────────
  {
    ...
    intro: [
      { bg:'haarlem_bedroom', pose:'idle',    caption:'Haarlem. Sunday morning. Canal outside.' },
      { bg:'haarlem_bedroom', pose:'idle',    caption:'Dad keeps saying we\'re Dutch. But what does that actually mean?' },
      { bg:'closeup',         pose:'reading', caption:'"Duinhoven. Dune garden." — That\'s us.' },
  ...
  // ── Starling ──────────────────────────────────────────
  {
    ...
    intro: [
      { bg:'haarlem_living', pose:'surprised', caption:'Everything is very tall when you\'re small.' },
      { bg:'haarlem_living', pose:'idle',      caption:'A small wooden box. It rattles.' },
  ...
  // ── Charlotte ─────────────────────────────────────────
  {
    ...
    intro: [
      { bg:'mn_bedroom', pose:'idle',    caption:'Dad and his history stuff.' },
  ...
  // ── Knoxley ───────────────────────────────────────────
  {
    ...
    emoji:    '🗝️',
    branch:   "Chuck & Daina · Minnesota, US",
    hook:     "I want to find the oldest ancestor possible.",
    startEra: 7,
    questIds: ['deep_roots'],
    sprite:   { hairColor:'#404030', bodyColor:'#304050', skinColor:'#c89060' },
    ending:   '"Before the Name" glows in your journal. 1450. You found the very beginning.',
    intro: [
      { bg:'mn_office', pose:'pointing', caption:'"Dirck van Duinhoven, ~1450." Five hundred and seventy years ago.' },
      { bg:'mn_office', pose:'idle',     caption:'"FAMILY PAPERS — DO NOT THROW." Now you know why.' },
      { bg:'closeup',   pose:'reading',  caption:'A circle drawn on the map: Aarle-Rixtel. Someone wanted to remember exactly where they came from.' },
      { bg:'sleep',     pose:'sleeping', caption:'1450. You\'re going to find out what was there.' },
    ],
  },
